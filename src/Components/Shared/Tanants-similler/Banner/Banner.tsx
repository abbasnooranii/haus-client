const Banner = ({ title, width }: { title: string; width?: string }) => {
  return (
    <div className="hidden md:flex bg-image tanants-similler-banner min-h-[464px] md:min-h-[640px] mt-12 pb-36 items-end">
